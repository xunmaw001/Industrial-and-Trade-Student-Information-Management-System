            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学生证书登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="zhengshuName" name="zhengshuName" class="form-control"
                                               v-model="ruleForm.zhengshuName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>证书类型</label>
                                    <input id="zhengshuValue" name="zhengshuValue" class="form-control"
                                           v-model="ruleForm.zhengshuValue" readonly>
                                </div>


                                    <div class="form-group col-md-6">
                                        <label>获取证书时间</label>
                                        <input id="zhengshuTime" name="zhengshuTime" class="form-control"
                                               v-model="ruleForm.zhengshuTime" readonly>
                                    </div>
