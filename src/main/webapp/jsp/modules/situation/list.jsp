    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">上课情况管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">上课情况管理</li>
                        <li class="breadcrumb-item active">上课情况列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">上课情况列表</h3>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <select name="situationTypesSelectSearch"  style="width: 150px;" id="situationTypesSelectSearch" class="form-control form-control-sm"
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    年份
                                    <div class="layui-input-inline">
                                        <input type="datetime-local" id="situationTimeStartSearch" style="width: 190px;" class="form-control form-control-sm"
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    <div class="layui-input-inline">
                                        <input type="datetime-local" id="situationTimeEndSearch" style="width: 190px;" class="form-control form-control-sm"
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    学期
                                    <div class="layui-input-inline">
                                        <input type="text" id="xueqiSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="学期" aria-controls="tableId">
                                    </div>
                                </div>
...
<script>
    ...
    function search() {
        ...
        if(banjiTypesSelectSearchInput != null){
            ...
            //上课情况
        var situationTypesSelectSearchInput = document.getElementById("situationTypesSelectSearch");
        if(situationTypesSelectSearchInput != null){
            var situationTypesIndex = situationTypesSelectSearchInput.selectedIndex;
            if( situationTypesIndex  != 0){
                searchForm.situationTypes= document.getElementById("situationTypesSelectSearch").options[situationTypesIndex].value;
            }
        }
     
        var situationTimeStartSearch = $('#situationTimeStartSearch');
        if( situationTimeStartSearch != null){
            if (situationTimeStartSearch.val() != null && situationTimeStartSearch.val() != '') {
                searchForm.situationTimeStart = $('#situationTimeStartSearch').val();
            }
        }
        var situationTimeEndSearch = $('#situationTimeEndSearch');
        if( situationTimeEndSearch != null){
            if (situationTimeEndSearch.val() != null && situationTimeEndSearch.val() != '') {
                searchForm.situationTimeEnd = $('#situationTimeEndSearch').val();
            }
        }
     
        //学期
        var xueqiSearchInput = $('#xueqiSearch');
        if( xueqiSearchInput != null){
            if (xueqiSearchInput.val() != null && xueqiSearchInput.val() != '') {
    ...
    function getDataList() {
        http("situation/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
            //本表的
            situationTypes: searchForm.situationTypes,
            situationTimeStart: searchForm.situationTimeStart,
            situationTimeEnd: searchForm.situationTimeEnd,
    ...
    function setDataRow(item, number) {
        ...
        //上课情况
        var situationTypesCell = document.createElement('td');
        situationTypesCell.innerHTML = item.situationValue;
        row.appendChild(situationTypesCell);


        //年份
        var situationTimeCell = document.createElement('td');
        situationTimeCell.innerHTML = item.situationTime;
        row.appendChild(situationTimeCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("situation/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addsituation", "addsituation");
        window.location.href = "add-or-update.jsp"
    }
    ...
    //填充本表搜索下拉框
        ...
        function situationTypesSelectSearch() {
            var situationTypesSelectSearch = document.getElementById('situationTypesSelectSearch');
            if(situationTypesSelectSearch != null) {
                situationTypesSelectSearch.add(new Option('-请选择-',''));
                if (situationTypesOptions != null && situationTypesOptions.length > 0){
                    for (var i = 0; i < situationTypesOptions.length; i++) {
                            situationTypesSelectSearch.add(new Option(situationTypesOptions[i].indexName,situationTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
        function situationTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=situation_types", "GET", {}, (res) => {
                if(res.code == 0){
                    situationTypesOptions = res.data.list;
                }
            });
        }
