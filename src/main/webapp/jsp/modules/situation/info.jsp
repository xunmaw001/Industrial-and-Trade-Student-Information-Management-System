            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">上课情况登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>上课情况</label>
                                    <input id="situationValue" name="situationValue" class="form-control"
                                           v-model="ruleForm.situationValue" readonly>
                                </div>


                                    <div class="form-group col-md-6">
                                        <label>年份</label>
                                        <input id="situationTime" name="situationTime" class="form-control"
                                               v-model="ruleForm.situationTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xueqi" name="xueqi" class="form-control"
                                               v-model="ruleForm.xueqi" readonly>
                                    </div>
