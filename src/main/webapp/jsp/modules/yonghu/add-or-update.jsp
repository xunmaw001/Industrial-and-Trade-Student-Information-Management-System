...
<script>
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '老师') {
            ...
            $('#yonghuXuehao').attr('readonly', 'readonly');
            $('#yonghuName').attr('readonly', 'readonly');
            $('#sexTypesSelect').attr('readonly', 'readonly');
            $('#sexTypesSelect').attr('style', 'pointer-events: none;');
            $('#yonghuIdNumber').attr('readonly', 'readonly');
            $('#yonghuPhone').attr('readonly', 'readonly');
            $('#yonghuPhotoupload').remove();
        }else if(window.sessionStorage.getItem('role') == '用户'){
            // $('#banjiTypesSelect').attr('readonly', 'readonly');
            $('#banjiTypesSelect').attr('style', 'pointer-events: none;');
        }
    }
