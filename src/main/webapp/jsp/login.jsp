                            ...
                            <form id="loginForm" action="" method="post" class="form-validate">
                                ...
                                <div class="form-group">
                                    <div class="checkbox-list">
                                        <label>
                                            <input type="radio" name="chk" value="管理员" onclick="checkRole('管理员', 'users')">&nbsp;管理员
                                        </label>
                                    </div>
                                    <div class="checkbox-list">
                                        <label>
                                            <input type="radio" name="chk" value="老师" onclick="checkRole('老师', 'laoshi')">&nbsp;老师
                                        </label>
                                    </div>
                                    <div class="checkbox-list">
                                        <label>
                                            <input type="radio" name="chk" value="用户" onclick="checkRole('用户', 'yonghu')">&nbsp;学生
                                        </label>
                                    </div>
                                </div>
