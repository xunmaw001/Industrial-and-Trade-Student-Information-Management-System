    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">学生证书管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">学生证书列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">学生证书列表</h3>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    ...
                                    <div class="layui-input-inline">
                                        <input type="text" id="zhengshuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                               placeholder="证书名" aria-controls="tableId">
                                    </div>
                                </div>
                                ...
                                <div class="layui-inline" style="margin-bottom: 10px;">
                                    证书类型
                                    <div class="layui-input-inline">
                                        <select name="zhengshuTypesSelectSearch"  style="width: 150px;" id="zhengshuTypesSelectSearch" class="form-control form-control-sm"
...
<script>
    ...
    function search() {
        ...
        //证书名
        var zhengshuNameSearchInput = $('#zhengshuNameSearch');
        if( zhengshuNameSearchInput != null){
            if (zhengshuNameSearchInput.val() != null && zhengshuNameSearchInput.val() != '') {
                searchForm.zhengshuName = $('#zhengshuNameSearch').val();
            }
        }
     
            //证书类型
        var zhengshuTypesSelectSearchInput = document.getElementById("zhengshuTypesSelectSearch");
        if(zhengshuTypesSelectSearchInput != null){
            var zhengshuTypesIndex = zhengshuTypesSelectSearchInput.selectedIndex;
            if( zhengshuTypesIndex  != 0){
                searchForm.zhengshuTypes= document.getElementById("zhengshuTypesSelectSearch").options[zhengshuTypesIndex].value;
            }
        }
                getDataList();
    }
    ...
    function getDataList() {
        http("zhengshu/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
            //本表的
            zhengshuName: searchForm.zhengshuName,
            zhengshuTypes: searchForm.zhengshuTypes,
            //级联表的
    ...
    function setDataRow(item, number) {
        ...
        //证书名
        var zhengshuNameCell = document.createElement('td');
        zhengshuNameCell.innerHTML = item.zhengshuName;
        row.appendChild(zhengshuNameCell);


        //证书类型
        var zhengshuTypesCell = document.createElement('td');
        zhengshuTypesCell.innerHTML = item.zhengshuValue;
        row.appendChild(zhengshuTypesCell);


        //获取证书时间
        var zhengshuTimeCell = document.createElement('td');
        zhengshuTimeCell.innerHTML = item.zhengshuTime;
        row.appendChild(zhengshuTimeCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("zhengshu/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addzhengshu", "addzhengshu");
        window.location.href = "add-or-update.jsp"
    }
    ...
    //填充本表搜索下拉框
        ...
        function zhengshuTypesSelectSearch() {
            var zhengshuTypesSelectSearch = document.getElementById('zhengshuTypesSelectSearch');
            if(zhengshuTypesSelectSearch != null) {
                zhengshuTypesSelectSearch.add(new Option('-请选择-',''));
                if (zhengshuTypesOptions != null && zhengshuTypesOptions.length > 0){
                    for (var i = 0; i < zhengshuTypesOptions.length; i++) {
                            zhengshuTypesSelectSearch.add(new Option(zhengshuTypesOptions[i].indexName,zhengshuTypesOptions[i].codeIndex));
                    }
                }
            }
        }
